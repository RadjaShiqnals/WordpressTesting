...
// add_action('updraftplus_settings_afternavtabs', array($this, 'settings_afternavtabs'));
	...
	public function options_printpage() {
		...
		$this->connected = !empty($options['email']) ? $updraftplus_addons2->connection_status() : true;
		...
		if (UpdraftPlus_Options::get_updraft_option('updraftplus_com_and_udc_connection_success', true)) {
